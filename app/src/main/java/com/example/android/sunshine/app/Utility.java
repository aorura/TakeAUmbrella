...
public class Utility {
    ...
    public static String getPreferredRainbow(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_rainbow_key),
                context.getString(R.string.pref_rainbow_default));
    }
    ...
    public static String formatTemperatureWithoutDegree(Context context, double temperature) {
        // Data stored in Celsius by default.  If user prefers to see in Fahrenheit, convert
        // the values here.
        //String suffix = "\u00B0";
        if (!isMetric(context)) {
        ...
        // For presentation, assume the user doesn't care about tenths of a degree.
        return String.format(context.getString(R.string.format_temperature_without_degree), temperature);
    }
